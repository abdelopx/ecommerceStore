@extends ('layouts/app')
<head><link rel="stylesheet" href="http://localhost/MyStore/resources/css/home.css"></head>
  <main>
    <div class="container">
      <div class="row">
        ...
        <div class="col-md-6 align-self-center">
          <h1><strong>We are sorry...</strong></h1>
          <h2> The product is not available</h2>
          <p>The product that you requested for is actually out of stock. But dont worry you will
            be notified as soon as it is available.
          </p>
          <form method="get" action="/MyStore/public/homePage">
            <button url class="btn" >HOME</button>
        </form>
